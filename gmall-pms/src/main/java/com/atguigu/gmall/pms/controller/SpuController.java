...
public class SpuController {
    ...
    public ResponseVo<PageResultVo> getSpuInfo(@PathVariable long categoryId,PageParamVo paramVo){
        PageResultVo resultVo = spuService.getSpuInfo(categoryId,paramVo);
